...
public class HorizontalMusicAdapter extends RecyclerView.Adapter<HorizontalMusicAdapter.ViewHolder> {
    ...
    public HorizontalMusicAdapter(List<HomePageResponse.MusicInfo> musicList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_horizontal_music, parent, false);
